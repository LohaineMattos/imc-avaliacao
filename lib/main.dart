...
class AvaliacaoIMC extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primarySwatch: Colors.teal, // Alterado para teal
      ),
      home: const TelaIMC(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Calculadora de IMC",
        ), // Alterado para "Calculadora de IMC"
        backgroundColor: Colors.deepOrange, // Alterado para deep orange
        actions: const [
          Padding(
      ...
      backgroundColor: const Color(0xFFE0F7FA), // Alterado para um azul claro
      body: Padding(
